...
export default function AddContentPage() {
  ...
  function handleUpload(e) {
    e.preventDefault();
    if (!title || !classroom) return setMessage("Please enter title and select classroom");
        ...
        <div className="p-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Select class and subject, then upload content.</CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleUpload} className="grid gap-2">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="text-sm self-center">{message}</div>
                </div>
              </form>
