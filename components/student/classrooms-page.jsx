...
const sectionsData = [
  {
    ...
    averageGrade: "A-",
    topPerformers: [
      { name: "Emma Wilson", xp: 2680, subject: "Mathematics" },
      { name: "Mike Chen", xp: 2450, subject: "Science" },
      { name: "Sarah Davis", xp: 2340, subject: "English" },
    ],
    studentTitles: [
      {
        title: "Math Champion",
  ...
  },
  {
    ...
    averageGrade: "B+",
    topPerformers: [
      { name: "David Kim", xp: 2590, subject: "Science" },
      { name: "Anna Martinez", xp: 2380, subject: "Mathematics" },
      { name: "Ryan Lee", xp: 2290, subject: "History" },
    ],
    studentTitles: [
      {
  ...
  },
  {
    ...
    averageGrade: "B",
    topPerformers: [
      { name: "Grace Taylor", xp: 2420, subject: "English" },
      { name: "Jack Wilson", xp: 2310, subject: "Art" },
      { name: "Maya Patel", xp: 2180, subject: "Music" },
    ],
    studentTitles: [
      {
  ...
  },
  {
    ...
    averageGrade: "B+",
    topPerformers: [
      { name: "Oliver Smith", xp: 2480, subject: "Mathematics" },
      { name: "Sophia Brown", xp: 2350, subject: "Science" },
      { name: "James Wilson", xp: 2240, subject: "English" },
    ],
    studentTitles: [
      {
